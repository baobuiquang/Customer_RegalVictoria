...
try {
    ...
    var nav_links = document.getElementsByClassName("nav-links")[0];
    var nav_content = document.getElementsByClassName("nav-content")[0];
...
try {
    ...
    function enableDarkMode() {
        ...
        console.log("Atom UI >> enableDarkMode");
    }
    function disableDarkMode() {
        document.body.classList.remove("darkmode");
        localStorage.setItem("isDarkMode", "false");
        document.getElementById("darkmodeCheck").checked = false;
        console.log("Atom UI >> disableDarkMode");
    }
